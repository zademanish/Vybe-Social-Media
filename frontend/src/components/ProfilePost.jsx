...
const ProfilePost = ({ post }) => {
  ...
  return (
    <div className="w-full h-[700px] mx-auto flex flex-col pb-2 gap-4 text-white bg-gradient-to-br from-gray-900 via-purple-400 to-gray-900  rounded-2xl shadow-md shadow-purple-500/50 transition-all duration-300 hover:shadow-purple-500/70">
      {/* Media */}
      <div className="relative w-full h-[100%] flex justify-center overflow-hidden">
        ...
        {post.mediaType === "video" && <ProfileVideoPlayer media={post.media} />}
